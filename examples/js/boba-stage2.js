...
$(document).ready(function() {
	...
	var loadData = function (data) {
		...
		//chlorpleth layer with election data. will revist this with boba data later
		...
		//q1 stands for "Question 1" of the boba survey. other questions may be added as another layer later on
		var q1Options = {
			recordsField: null,
			locationMode: L.LocationModes.STATE,
			codeField: 'State',
